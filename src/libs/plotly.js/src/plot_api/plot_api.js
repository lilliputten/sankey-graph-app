...
function _doPlot(gd, data, layout, config) {
  window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:_doPlot]', { gd, data, layout, config });
    var frames;
...
function redraw(gd) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:redraw]', gd);
    gd = Lib.getGraphDiv(gd);
...
function newPlot(gd, data, layout, config) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:newPlot]', { gd, data, layout, config });
    gd = Lib.getGraphDiv(gd);
...
function addTraces(gd, traces, newIndices) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:addTraces]', { gd, traces, newIndices });
    gd = Lib.getGraphDiv(gd);
...
function moveTraces(gd, currentIndices, newIndices) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:moveTraces]', { gd, currentIndices, newIndices });
    gd = Lib.getGraphDiv(gd);
...
function restyle(gd, astr, val, _traces) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:restyle]', { gd, astr, val, _traces });
    gd = Lib.getGraphDiv(gd);
...
function _restyle(gd, aobj, traces) {
    ...
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:_restyle]', { gd, aobj, traces });
    var fullLayout = gd._fullLayout;
    var fullData = gd._fullData;
    var data = gd.data;
    ...
    for(var ai in aobj) {
        ...
        window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:_restyle] start processing data', {
            traces,
            flags: {...flags},
            ai,
            vi,
        ...
        for(i = 0; i < traces.length; i++) {
            ...
            // NOTE: Update flags if no safe field detected
                ...
                if (isSafeField) {
                    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:_restyle] before update flags for isSafeField', {
                        flags: {...flags},
                        ai,
                        valObject,
                        // gd, aobj, trace,
                ...
                if (isSafeField) {
                    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:_restyle] before set param for isSafeField', {
                        flags: {...flags},
                        ai,
                        newVal,
                        // gd, aobj, trace,
...
function relayout(gd, astr, val) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:relayout]', { gd, astr, val });
    gd = Lib.getGraphDiv(gd);
    helpers.clearPromiseQueue(gd);
...
function update(gd, traceUpdate, layoutUpdate, _traces) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:update]', { gd, traceUpdate, layoutUpdate, _traces });
    gd = Lib.getGraphDiv(gd);
    helpers.clearPromiseQueue(gd);
...
function findUIPattern(key, patternSpecs) {
    // window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:findUIPattern]', { key, patternSpecs });
...
function react(gd, data, layout, config) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:react]', { gd, data, layout, config });
    var frames, plotDone;
...
function addFrames(gd, frameList, indices) {
    window.__DEBUG_PLOTLY && window.__DEBUG_PLOTLY.includes('plot_api') && console.log('[plotly:plot_api:addFrames]', { gd, frameList, indices });
    gd = Lib.getGraphDiv(gd);
